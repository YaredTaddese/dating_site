<?php
        ...
        public function update()
         {
             ...
             $qAge = (empty($this->ageRange)) ? "" : implode(",",$this->ageRange);
             $qHeight = (empty($this->heightRange)) ? "" : implode(",",$this->heightRange);
             //update profile in database
             $query = "update criteria
                       set mStatus='".$this->mStatus."', religion='".$this->religion."', 
                           haveChildren='".$this->haveChildren."', heightRange='".$qHeight."',
         ...
         function viewAsEditable(){
             ?>
             <form  action="editPage.php" method="get" class="editableForm">
          
          <div class="col-3">
            <label>
              AGE RANGE <br/>
              <input 
              <?php  if(!empty($this->ageRange[0])){
    ...
    <?php if(!empty($this->heightRange[0])){
    ...
    <?php if(!empty($this->heightRange[1])){
    ...
    <?php echo "<option value='$this->haveChildren' selected>$this->haveChildren</option>"; ?>
            ...
            <input type="hidden" name="criteria" value="yes" />
      <div class="col-submit">
	        <input type="submit" name="criteriaUpdate" class="submitbtn" value="Update"/>
	    </div>
