<?php
    ...
    class ProfileInfo
    {
        ...
        public function update()
         ...
         function viewAsEditable($phoneNumberError){
             ?> 
                
    <form action="../view/editPage.php" method="get"  class="editableForm">
    ...
    <?php echo "<option value='$this->drinking' selected>$this->drinking</option>"; ?>
          ...
          <div class="col-2">
	        <label>
	          Phone Number
	          <input <?php echo "value='$this->phoneNumber'" ?> type="tel"  name="phoneNumber" tabindex="5" >
	        </label>
	      </div>    	      
          ...
          ?>
              <input type="hidden" name="additional" value="yes" />  
	    <div class="col-submit">
	        <input type="submit" name="moreUpdate" class="submitbtn" value="Update"/>
	    </div>
